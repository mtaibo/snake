...
# Components from template structure
from snake.components.template_components.left_panel import left_panel
from snake.components.template_components.board_area import board_area
